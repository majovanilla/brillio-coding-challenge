(function () {
  ...
  Shopify.OptionSelectors2 = function (container, options) {
    ...
    var variantIdInput = this.variantIdInput = document.querySelector(variantIdInputSelector);
    ...
    function updateVariantId() {
      ...
      console.log('change variant input-----');
      console.log('variantIdInput', variantIdInput);
      console.log('variant.id', variant.id);


      variantIdInput.value = variant.id;
      console.log('variantIdInput.value', variantIdInput.value);
